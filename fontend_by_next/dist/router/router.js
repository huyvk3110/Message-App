...
const router_api_users_1 = __importDefault(require("./api/router.api.users"));
const router_api_auth_1 = __importDefault(require("./api/router.api.auth"));
const router_api_account_1 = __importDefault(require("./api/router.api.account"));
